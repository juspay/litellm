...
def cleanup_router_config_variables():
    global master_key, user_config_file_path, otel_logging, user_custom_auth, user_custom_auth_path, user_custom_key_generate, user_custom_sso, user_custom_ui_sso_sign_in_handler, use_background_health_checks, use_shared_health_check, health_check_interval, prisma_client, prisma_read_client
...
async def proxy_shutdown_event():
    global prisma_client, prisma_read_client, master_key, user_custom_auth, user_custom_key_generate
