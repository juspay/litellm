    ...
    async def async_streaming_data_generator(
        ...
        *,
        ...
        try:
            ...
            # branches above already own their own release. Fire-and-forget
            # with an internal timeout bound (in the limiter) so a slow Redis
            # release can never stall the generator cleanup.
